...
enum class ScreenName(val screenName: String) {
    ...
    ANSWER_WORKBOOK("ANSWER_WORKBOOK"),
    RESULT_ANSWER_WORKBOOK("RESULT_ANSWER_WORKBOOK"),
    LIST_PUBLISH_WORKBOOK("LIST_PUBLISH_WORKBOOK"),
    LIST_GROUP("LIST_GROUP"),
    LIST_GROUP_WORKBOOK("LIST_GROUP_WORKBOOK"),
    SETTINGS("SETTINGS")
}