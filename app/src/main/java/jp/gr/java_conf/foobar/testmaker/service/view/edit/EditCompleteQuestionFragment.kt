...
class EditCompleteQuestionFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        editCompleteQuestionViewModel.imagePath.observeNonNull(viewLifecycleOwner) {
        ...
        return DataBindingUtil.inflate<FragmentEditCompleteQuestionBinding>(inflater, R.layout.fragment_edit_complete_question, container, false).apply {
            ...
            buttonImage.setOnClickListener {
                AlertDialog.Builder(requireContext(), R.style.MyAlertDialogStyle)
                        .setItems(
                                if (!editCompleteQuestionViewModel.imagePath.value.isNullOrEmpty()) resources.getStringArray(R.array.action_image) else resources.getStringArray(R.array.action_image).take(2).toTypedArray()
                        ) { _, which ->
                            ...
                            when (which) {
                                ...
                                REMOVE -> {
                                    editCompleteQuestionViewModel.imagePath.value = ""
        ...
        try {
            ...
            AlertDialog.Builder(requireContext(), R.style.MyAlertDialogStyle)
                    ...
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        ...
                        editCompleteQuestionViewModel.imagePath.value = fileName
                        binding?.buttonImage?.setImageWithGlide(requireContext(), cropView.croppedBitmap)

                        lifecycleScope.launch {
                            editCompleteQuestionViewModel.imagePath.value?.let {
