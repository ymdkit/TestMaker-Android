...
class TestTest {
    ...
    // todo Workbook 用に置き換え
    @Test
    fun testGetRandomExtractedAnswers() {
//        var test = MyTest(title = "", color = 0, source = "")
//        assertEquals(emptyList<String>(), test.getRandomExtractedAnswers(listOf()).sorted())
//
//        // 一つ追加
//        test = test.copy(questions = listOf(Question(answer = "answer1")))
//        assertEquals(listOf("answer1"), test.getRandomExtractedAnswers(listOf()).sorted())
//
//        // 重複削除
...
//        assertEquals(listOf("answer1", "answer2"), test.getRandomExtractedAnswers(listOf()).sorted())
//
//        // 一つ追加（複数回答）
...
//        assertEquals(listOf("answer1", "answer2", "answer3", "answer4"), test.getRandomExtractedAnswers(listOf()).sorted())
//
//        // 複数形式の混合
...
//        assertEquals(listOf("answer1", "answer2", "answer3"), test.getRandomExtractedAnswers(listOf()).sorted())
//
//        // 複数形式の混合かつ重複削除
